    ...
    <div className="landingPage">
        <div className="landingHero">
          ...
          <div className="landingHero-title">
            <h1 className="banner-h1">Pack your Bags on an Extraordinary Flight Booking Experience!</h1>
            <p className="banner-p">Embark on a journey of a lifetime and book exceptional flights to breathtaking destinations, where every adventure is more unforgettable than the last.</p>     
          </div>
        ...
        <div className="container">
            ...
            <span><h5>2024 VIT Flights - &copy; All rights reserved</h5></span>
